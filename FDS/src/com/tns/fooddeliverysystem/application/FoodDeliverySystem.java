...
default:
	...
	private static void removeFoodItemFromRestaurant (Scanner scanner) {
		...
		System.out.print("Enter Delivery Person ID: "); int id = scanner.nextInt();
		System.out.print("Enter Delivery Person Name: ");
		String name = scanner.next();
		System.out.print("Enter Contact No.: ");
		long contactNo = scanner.nextLong();
		DeliveryPerson deliveryPerson = new DeliveryPerson (id, name, contactNo); orderService.addDeliveryPerson (deliveryPerson);
